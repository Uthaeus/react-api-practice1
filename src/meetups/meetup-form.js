...
function MeetupForm({ meetup }) {
    ...
    return (
        <form onSubmit={handleSubmit(submitHandler)} className="meetup-form">
            <div className="form-col-one">
                ...
                <div className="form-group mb-4">
                    ...
                    <textarea className="form-control" name="description" id="description" rows={6} {...register("description", { required: true })} />
            ...
            <div className="form-col-two">
                <div className="form-group text-end">
                    <button type="submit" className="meetup-form-btn">
